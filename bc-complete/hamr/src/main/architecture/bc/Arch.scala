...
object Arch {
  val BuildingControlDemo_i_Instance_tcp_tempSensor : bc.BuildingControl.TempSensor_i_Bridge = {
    ...
    bc.BuildingControl.TempSensor_i_Bridge(
      id = 0,
  ...
  val BuildingControlDemo_i_Instance_tcp_tempControl : bc.BuildingControl.TempControl_i_Bridge = {
    ...
    bc.BuildingControl.TempControl_i_Bridge(
      id = 1,
  ...
  val BuildingControlDemo_i_Instance_tcp_fan : bc.BuildingControl.Fan_i_Bridge = {
    ...
    bc.BuildingControl.Fan_i_Bridge(
      id = 2,
