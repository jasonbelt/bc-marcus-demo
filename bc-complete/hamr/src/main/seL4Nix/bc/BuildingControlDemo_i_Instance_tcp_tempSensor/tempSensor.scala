...
package bc.BuildingControlDemo_i_Instance_tcp_tempSensor
...
import bc._
import bc.BuildingControl.TempSensor_i_seL4Nix

object tempSensor extends App {

  val tempSensorBridge : bc.BuildingControl.TempSensor_i_Bridge = {
