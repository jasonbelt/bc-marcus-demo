...
package bc.BuildingControlDemo_i_Instance_tcp_tempControl
...
import bc._
import bc.BuildingControl.TempControl_i_seL4Nix

object tempControl extends App {

  val tempControlBridge : bc.BuildingControl.TempControl_i_Bridge = {
